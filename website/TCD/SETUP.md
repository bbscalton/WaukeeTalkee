...
|----------|--------|----------|----------------|--------------|
| Taxi / demo (default) | `demo` | taxi | [/](https://bbscalton.github.io/WaukeeTalkee/) | [/app/](https://bbscalton.github.io/WaukeeTalkee/app/) |
...
Each seed creates/updates `orgs/{orgId}` with the correct `solution`, `displayName`, and default `features`, plus `orgs/{orgId}/dispatchers/{uid}`.
